...
Gao and Zhu consider estimation under a squared error loss. This loss function leads to the following empirical risk minimization criteria:
...
\end{equation}
Which equivalent formulations of the empirical loss in \ref{eq:loss_func} we will use depends on the further assumptions we will make on the graphon. In the stochastic block model it makes more sense to refer to the second equation, while for a general smooth $f$ it clearer to work with the first formulation.
